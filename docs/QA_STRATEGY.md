...
| 8-channel pipette | 8 tips spanning all 8 rows → fills one full **column** (e.g. A1–H1) | **High** | Count tip-like objects; if 8 vertically aligned, flag 8-channel mode | Predict 8 wells sharing same column; validate all well_column values are equal |
| 12-channel pipette | 12 tips spanning all 12 columns → fills one full **row** (e.g. A1–A12) | **High** | Count tip-like objects; if 12 horizontally aligned, flag 12-channel mode | Predict 12 wells sharing same row; validate all well_row values are equal |
